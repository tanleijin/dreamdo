...
<header class="main-header">
	...
	<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		...
		<span class="logo-lg">DreamDo</span>
	</a>
...
<aside class="main-sidebar" >
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
      	...
      	<li class="<#if active == 'dashboard'>active treeview <#else>treeview</#if>">
          <a href="/admin/main">
            <i class="fa fa-dashboard"></i> <span>统计</span>
          </a>
        </li>
        <li class="<#if active == 'user'>active treeview<#else>treeview</#if> ">
          <a href="/admin/user">
            <i class="fa  fa-user-o"></i> <span>用户管理</span>
          </a>
        </li>
        <li class="<#if active == 'article'>active treeview<#else>treeview</#if>">
          <a href="/admin/article">
            <i class="fa fa-book"></i> <span>文章管理</span>
          </a>
        </li>
        <li class="<#if active == 'comment'>active treeview<#else>treeview</#if>">
          <a href="/admin/comment">
            <i class="fa fa-commenting-o"></i> <span>评论管理</span>
          </a>
        </li>
        <li class="<#if active == 'log'> active treeview <#else> treeview </#if>">
          <a href="/admin/syslog">
            <i class="fa fa-eye"></i> <span>日志管理</span>
          </a>
        </li>
        <li class="<#if active == 'system'> active treeview <#else> treeview </#if>">
          <a href="#">
