...
<script>window.jQuery || document.write(unescape("%3Cscript src='/webjars/jquery/jquery.min.js' type='text/javascript'%3E%3C/script%3E"))</script>
...
<script>window.jQuery.fn.modal || document.write(unescape("%3Cscript src='/webjars/bootstrap/js/bootstrap.min.js' type='text/javascript'%3E%3C/script%3E"))</script>

<script src="/webjars/bootstrap-notify/bootstrap-notify.min.js"></script>
...
<script src="/webjars/sweetalert/sweetalert.min.js"></script>
